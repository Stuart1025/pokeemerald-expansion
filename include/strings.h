...
extern const u8 gText_PsychicNoise[];
extern const u8 gText_LowKick[];
extern const u8 gText_ElectroBall[];
extern const u8 gText_LashOut[];
extern const u8 gText_SignalBeam[];
extern const u8 gText_StompingTantrum[];
extern const u8 gText_TemperFlare[];
...
extern const u8 gText_ConfuseRay[];
...
extern const u8 gText_ScaleShot[];
...
extern const u8 gText_TerrainPulse[];
...
extern const u8 gText_MuddyWater[];
...
extern const u8 gText_HeavySlam[];
...
extern const u8 gText_FeatherDance[];
...
extern const u8 gText_FutureSight[];
extern const u8 gText_Megahorn[];
extern const u8 gText_Outrage[];
extern const u8 gText_MeteorBeam[];
extern const u8 gText_VoltTackle[];
extern const u8 gText_WaveCrash[];
...
extern const u8 PokemonCenterMoveTutor_Text_FireSpinDesc[];
extern const u8 PokemonCenterMoveTutor_Text_WhirlpoolDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SandTombDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PoisonTailDesc[];
extern const u8 PokemonCenterMoveTutor_Text_KnockOffDesc[];
extern const u8 PokemonCenterMoveTutor_Text_VacuumWaveDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PounceDesc[];
extern const u8 PokemonCenterMoveTutor_Text_EchoedVoiceDesc[];
extern const u8 PokemonCenterMoveTutor_Text_AcidSprayDesc[];
extern const u8 PokemonCenterMoveTutor_Text_RapidSpinDesc[];
extern const u8 PokemonCenterMoveTutor_Text_DrainingKissDesc[];
extern const u8 PokemonCenterMoveTutor_Text_StruggleBugDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_CharmDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MetronomeDesc[];

// Set 2
extern const u8 PokemonCenterMoveTutor_Text_SwiftDesc[];
extern const u8 PokemonCenterMoveTutor_Text_IncinerateDesc[];
extern const u8 PokemonCenterMoveTutor_Text_WaterPulseDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ShockWaveDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MagicalLeafDesc[];
extern const u8 PokemonCenterMoveTutor_Text_IcyWindDesc[];
extern const u8 PokemonCenterMoveTutor_Text_RevengeDesc[];
extern const u8 PokemonCenterMoveTutor_Text_VenoshockDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_BreakingSwipeDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MetalClawDesc[];
extern const u8 PokemonCenterMoveTutor_Text_CovetDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ElectroWebDesc[];
extern const u8 PokemonCenterMoveTutor_Text_AmnesiaDesc[];
extern const u8 PokemonCenterMoveTutor_Text_NightShadeDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BrutalSwingDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ScaryFaceDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_FlipTurnDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PsychicNoiseDesc[];
extern const u8 PokemonCenterMoveTutor_Text_LowKickDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ElectroBallDesc[];
extern const u8 PokemonCenterMoveTutor_Text_LashOutDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_TemperFlareDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SuperFangDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BurningJealousyDesc[];
extern const u8 PokemonCenterMoveTutor_Text_FlingDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MagicCoatDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ConfuseRayDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MetalSoundDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_ScaleShotDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SeedBombDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ScorchingSandsDesc[];
extern const u8 PokemonCenterMoveTutor_Text_FakeTearsDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BatonPassDesc[];

// Set 5
extern const u8 PokemonCenterMoveTutor_Text_CrunchDesc[];
extern const u8 PokemonCenterMoveTutor_Text_TriAttackDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BlazeKickDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BodyPressDesc[];
extern const u8 PokemonCenterMoveTutor_Text_LiquidationDesc[];
extern const u8 PokemonCenterMoveTutor_Text_IceSpinnerDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PsychicFangsDesc[];
extern const u8 PokemonCenterMoveTutor_Text_DarkestLariatDesc[];
extern const u8 PokemonCenterMoveTutor_Text_EarthPowerDesc[];
extern const u8 PokemonCenterMoveTutor_Text_BounceDesc[];
extern const u8 PokemonCenterMoveTutor_Text_TerrainPulseDesc[];
extern const u8 PokemonCenterMoveTutor_Text_WeatherBallDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PollenPuffDesc[];
extern const u8 PokemonCenterMoveTutor_Text_AvalancheDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PetalBlizzardDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_HazeDesc[];
extern const u8 PokemonCenterMoveTutor_Text_CosmicPowerDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SpikesDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ScreechDesc[];
extern const u8 PokemonCenterMoveTutor_Text_GravityDesc[];
extern const u8 PokemonCenterMoveTutor_Text_EndeavorDesc[];

// Set 7
extern const u8 PokemonCenterMoveTutor_Text_MoonblastDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_HeavySlamDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SolarBladeDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ReversalDesc[];
extern const u8 PokemonCenterMoveTutor_Text_RisingVoltageDesc[];
extern const u8 PokemonCenterMoveTutor_Text_GrassyGlideDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MistyExplosionDesc[];
extern const u8 PokemonCenterMoveTutor_Text_ExpandingForceDesc[];
extern const u8 PokemonCenterMoveTutor_Text_IronDefenseDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MagicRoomDesc[];
extern const u8 PokemonCenterMoveTutor_Text_WonderRoomDesc[];
extern const u8 PokemonCenterMoveTutor_Text_SynthesisDesc[];
extern const u8 PokemonCenterMoveTutor_Text_FeatherDanceDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_TripleAxelDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_FutureSightDesc[];
extern const u8 PokemonCenterMoveTutor_Text_OutrageDesc[];
extern const u8 PokemonCenterMoveTutor_Text_VoltTackleDesc[];
extern const u8 PokemonCenterMoveTutor_Text_WaveCrashDesc[];
extern const u8 PokemonCenterMoveTutor_Text_MeteorBeamDesc[];
extern const u8 PokemonCenterMoveTutor_Text_PoltergeistDesc[];
...
extern const u8 PokemonCenterMoveTutor_Text_CoachingDesc[];
