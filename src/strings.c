...
const u8 gText_Venoshock[] = _("Venoshock");
...
const u8 gText_BreakingSwipe[] = _("Breaking Swipe");
const u8 gText_MetalClaw[] = _("Metal Claw");
const u8 gText_Covet[] = _("Covet");
const u8 gText_Electroweb[] = _("Electroweb");
const u8 gText_NightShade[] = _("Night Shade");
const u8 gText_BrutalSwing[] = _("Brutal Swing");
const u8 gText_ScaryFace[] = _("Scary Face");
const u8 gText_HelpingHand[] = _("Helping Hand");

// Unlocked after beating Gym 3
...
const u8 gText_PsychicNoise[] = _("Psychic Noise");
const u8 gText_LowKick[] = _("Low Kick");
const u8 gText_ElectroBall[] = _("Electro Ball");
const u8 gText_LashOut[] = _("Lash Out");
const u8 gText_SignalBeam[] = _("Signal Beam");
const u8 gText_StompingTantrum[] = _("Stomping Tantrum");
const u8 gText_TemperFlare[] = _("Temper Flare");
const u8 gText_SuperFang[] = _("Super Fang");
const u8 gText_BurningJealousy[] = _("Burning Jealousy");
const u8 gText_Fling[] = _("Fling");
const u8 gText_MagicCoat[] = _("Magic Coat");
const u8 gText_ConfuseRay[] = _("Confuse Ray");
...
const u8 gText_MuddyWater[] = _("Muddy Water");
...
const u8 gText_CosmicPower[] = _("Cosmic Power");
...
const u8 gText_HeavySlam[] = _("Heavy Slam");
const u8 gText_SolarBlade[] = _("Solar Blade");
const u8 gText_Reversal[] = _("Reversal");
const u8 gText_RisingVoltage[] = _("Rising Voltage");
const u8 gText_GrassyGlide[] = _("Grassy Glide");
const u8 gText_MistyExplosion[] = _("Misty Explosion");
const u8 gText_ExpandingForce[] = _("Expanding Force");
const u8 gText_IronDefense[] = _("Iron Defense");
const u8 gText_MagicRoom[] = _("Magic Room");
const u8 gText_WonderRoom[] = _("Wonder Room");
const u8 gText_Synthesis[] = _("Synthesis");
const u8 gText_FeatherDance[] = _("Feather Dance");
...
const u8 gText_FutureSight[] = _("Future Sight");
const u8 gText_Megahorn[] = _("Megahorn");
const u8 gText_Outrage[] = _("Outrage");
const u8 gText_MeteorBeam[] = _("Meteor Beam");
const u8 gText_VoltTackle[] = _("Volt Tackle");
const u8 gText_WaveCrash[] = _("Wave Crash");
const u8 gText_Poltergeist[] = _("Poltergeist");
