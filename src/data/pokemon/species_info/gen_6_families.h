...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities = { ABILITY_REGENERATOR, ABILITY_HYDRATION, ABILITY_GOOEY },
    ...
    [SPECIES_SLIGGOO_HISUI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_REGENERATOR, ABILITY_SHELL_ARMOR, ABILITY_GOOEY },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Sliggoo"),
        .cryId = CRY_SLIGGOO,
        .natDexNum = NATIONAL_DEX_SLIGGOO,
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_TRIAGE, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_BROWN,
